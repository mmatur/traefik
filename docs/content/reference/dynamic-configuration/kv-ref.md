...
| `traefik/http/services/Service02/loadBalancer/apiportal/groups/APIPortalGroup0/path` | `foobar` |
| `traefik/http/services/Service02/loadBalancer/apiportal/groups/APIPortalGroup1/path` | `foobar` |
| `traefik/http/services/Service02/loadBalancer/apiportal/path` | `foobar` |
