---
# AI code review for traefik/traefik. The review itself (firewall, tools, safe
...
#   gh aw add traefik/ai/traefik.ai-review -n ai-review --force
...
source: traefik/ai/workflows/traefik.ai-review.md@main
---

# Repository

`traefik/traefik` is public: pull requests usually come from forks.
